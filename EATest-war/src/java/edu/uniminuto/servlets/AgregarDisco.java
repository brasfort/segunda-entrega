 ...
 * @author Jhon Gómez
 */
@WebServlet(name = "AgregarDisco", urlPatterns = {"/agregardisco"})
public class AgregarDisco extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = getParameter(request, "vista");
        ...
        if (!id.isEmpty()) {
            ...
            elemento.setDiscoId(Integer.valueOf(id));
