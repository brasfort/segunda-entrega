 ...
 * @author Jhon Gómez
 */
@WebServlet(name = "DetalleInterprete", urlPatterns = {"/interprete"})
public class DetalleInterprete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Interprete interprete = interpreteFacade.find(Integer.valueOf(id));
                
                
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/interprete.jsp");
